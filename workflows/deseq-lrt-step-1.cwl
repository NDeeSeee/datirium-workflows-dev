...
inputs:
  ...
  expression_file_names:
    type: string[]
    label: "RNA-Seq experiments"
    doc: "Aliases for RNA-Seq experiments. The same aliases should be used in metadata
      file"
  ...
  reduced_formula:
    type: string
    label: "Reduced formula to compare against with the term(s) of interest removed.
      See workflow description for details"
    doc: "Reduced formula to compare against with the term(s) of interest removed.
      Should start with ~. See DESeq2 manual for details"
...
outputs:
  ...
  lrt_diff_expr:
    ...
    label: "Differentially expressed features grouped by isoforms, genes or common
      TSS"
    doc: "DESeq2 generated file of differentially expressed features grouped by isoforms,
  ...
  contrasts_table:
    ...
    doc: "This file contains all possible contrasts (main and interaction effects)
      generated by DESeq2 Wald test for the complex interaction design formula. The
      contrasts are grouped by isoforms, genes, or common TSS in TSV format."
  ...
  dsq_obj_data:
    ...
    doc: "This RDS file contains all possible contrasts (main and interaction effects)
      generated by DESeq2 Wald test for the complex interaction design formula."
...
label: "DESeq2 (LRT, step 1) - differential gene expression analysis using likelihood
  ratio test"
doc: |

...
inputs:
  ...
  genelist_file:
    type: File?
    label: Gene list to filter input genes. Headerless TSV/CSV file with 1 gene per
      line
    doc: Gene list to filter input genes. Headerless TSV/CSV file with 1 gene per
      line
    sd:layout:
      advanced: true
outputs:

...
outputs:
  ...
  raw_mito_dnst_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Unfiltered
          Caption: Distribution of RNA reads mapped to mitochondrial genes per cell
            (unfiltered)
  ...
  raw_umi_dnst_spl_cnd_plot_png:
    ...
    sd:visualPlugins:
      - image:
          ...
          Caption: Distribution of RNA reads per cell (unfiltered, split by grouping
            condition)
  ...
  raw_nvlt_dnst_spl_cnd_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Unfiltered, split by group
          Caption: Distribution of novelty score per cell (unfiltered, split by grouping
            condition)
  ...
  fltr_umi_dnst_spl_cnd_plot_png:
    ...
    sd:visualPlugins:
      - image:
          ...
          Caption: Distribution of RNA reads per cell (filtered, split by grouping
            condition)
  ...
  fltr_nvlt_dnst_spl_cnd_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Filtered, split by group
          Caption: Distribution of novelty score per cell (filtered, split by grouping
            condition)
  ucsc_cb_html_data:
    type: Directory

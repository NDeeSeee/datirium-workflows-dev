...
inputs:
  ...
  dimensions:
    type: int?
    default: 10
    label: Dimensionality to be used when running differential abundance analysis
      (from 1 to 50)
    doc: |
...
outputs:
  ...
  umap_da_scr_cnt_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: QC
          Caption: UMAP colored by differential abundance score (all cells, continuous
            scale)
  ...
  umap_da_scr_ctg_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: QC
          Caption: UMAP colored by differential abundance score (all cells, categorical
            scale)
  ...
  cmp_gr_tst_spl_clst_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Composition
          Caption: Composition plot colored by tested condition (split by cluster,
            downsampled)
  cmp_gr_clst_spl_tst_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Composition
          Caption: Composition plot colored by cluster (split by tested condition,
            downsampled)
  cmp_bp_gr_tst_spl_clst_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Composition
          Caption: Composition box plot colored by tested condition (split by cluster,
            downsampled)
  ucsc_cb_html_data:
    type: Directory?

...
inputs:
  ...
  sample_names_nabinding:
    ...
    doc: Array of aliases for ChIP/ATAC/CRT-Seq experiments for row metadata, param
      (-d)
  ...
  datafiles_nabinding:
    ...
    doc: Array of sample coordinate sorted BAM alignment and BAI index files, param
      (-f)

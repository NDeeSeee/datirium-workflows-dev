...
outputs:
  ...
  rna_atac_cnts_spl_clst_res_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: QC
          Caption: RNA reads vs ATAC fragments in peaks per cell (split by cluster,
            all cells)
  ...
  umap_gr_clst_spl_ph_res_plot_png:
    ...
    sd:visualPlugins:
      - image:
          tab: Split by cluster
          Caption: UMAP colored by cluster (split by cell cycle phase, optionally
            downsampled)
  cmp_gr_ph_spl_clst_res_plot_png:
    ...
    label: Composition plot colored by cell cycle phase (split by cluster, optionally
      downsampled)
    doc: |
    ...
    sd:visualPlugins:
      - image:
          tab: Split by cluster
          Caption: Composition plot colored by cell cycle phase (split by cluster,

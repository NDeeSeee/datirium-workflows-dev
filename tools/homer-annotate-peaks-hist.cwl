...
arguments:
  ...
  - valueFrom: $("none")
    position: 6
doc: "Tool is used to produce histogram or heatmaps only. Rest of the functionality
  is not implemented intentionally.\nIf TSS analysis needed, input peak_file should
  be centered on TSS, where the 'center' of the peak in the actual TSS.\nFor example:\n\

...
inputs:
  ...
  cbc_knn:
    ...
    doc: "Specify the number of nearest neighbors used to identify \nmutual nearest
      neighbors. Setting this too high will \nincrease runtime and may cause out of
      memory error. See \nChemistry Batch Correction page for more details. Ranges
      \nfrom 5 to 20.\nDefault: 10\n"
  cbc_alpha:
    type: float?
    doc: "Specify the threshold of the percentage of matched cells \nbetween two batches,
      which is used to determine if the \nbatch pair will be merged. See Chemistry
      Batch Correction \npage for more details. Ranges from 0.05 to 0.5.\nDefault:
      0.1\n"
  cbc_sigma:
    type: float?
    doc: "Specify the bandwidth of the Gaussian smoothing kernel \nused to compute
      the correction vector for each cell. See \nChemistry Batch Correction page for
      more details. Ranges \nfrom 10 to 500.\nDefault: 150\n"
  cbc_realign_panorama:
    type: boolean?
    doc: "Specify if two batches will be merged if they are already \nin the same
      panorama. Setting this to True will usually \nimprove performance, but will
      also increase runtime and \nmemory usage. See Chemistry Batch Correction page
      for \nmore details. One of true or false.\nDefault: false\n"
  graphclust_neighbors:
    type: int?
    doc: "Number of nearest-neighbors to use in the graph-based \nclustering. Lower
      values result in higher-granularity \nclustering. The actual number of neighbors
      used is the \nmaximum of this value and that determined by neighbor_a \nand
      neighbor_b. Set this value to zero to use those \nvalues instead. Ranged from
      10 to 500, depending on \ndesired granularity.\nDefault: 0\n"
  neighbor_a:
    type: float?
    doc: "The number of nearest neighbors, k, used in the graph-based \nclustering
      is computed as follows: k = neighbor_a + neighbor_b * \nlog10(n_cells). The
      actual number of neighbors used is the maximum \nof this value and graphclust_neighbors.
      Determines how clustering \ngranularity scales with cell count.\nDefault: -230.0\n"
  neighbor_b:
    type: float?
    doc: "The number of nearest neighbors, k, used in the graph-based \nclustering
      is computed as follows: k = neighbor_a + neighbor_b * \nlog10(n_cells). The
  ...
  max_clusters:
    ...
    doc: "Compute K-means clustering using K values of 2 to N. \nSetting this too
      high may cause spurious clusters to be \ncalled. Ranges from 10 to 50, depending
      on the number \nof cell populations/clusters you expect to see.\nDefault: 10\n"
  tsne_input_pcs:
    type: int?
    doc: "Subset to top N principal components for TSNE. Change \nthis parameter if
      you want to see how the TSNE plot \nchanges when using fewer PCs, independent
      of the \nclustering/differential expression. You may find that \nTSNE is faster
      and/or the output looks better when using \nfewer PCs. Cannot be set higher
      than the num_principal_comps \nparameter.\nDefault: null\n"
  tsne_perplexity:
    type: int?
    doc: "TSNE perplexity parameter (see the TSNE FAQ for more details). \nWhen analyzing
      100k+ cells, increasing this parameter may \nimprove TSNE results, but the algorithm
      will be slower. \nRanges from 30 to 50.\nDefault: 30\n"
  tsne_theta:
    type: float?
    doc: "TSNE theta parameter (see the TSNE FAQ for more details). \nHigher values
      yield faster, more approximate results (and \nvice versa). The runtime and memory
      performance of TSNE \nwill increase dramatically if you set this below 0.25.
      \nRanges from 0 to 1.\nDefault: 0.5\n"
  tsne_max_dims:
    type: int?
    doc: "Maximum number of TSNE output dimensions. Set this to 3 to \nproduce both
      2D and 3D TSNE projections (note: runtime will \nincrease significantly). Ranges
      from 2 to 3.\nDefault: 2\n"
  tsne_max_iter:
    type: int?
    doc: "Number of total TSNE iterations. Try increasing this if \nTSNE results do
      not look good on larger numbers of cells. \nRuntime increases linearly with
      the number of iterations. \nRanges from 1000 to 10000.\nDefault: 1000\n"
  tsne_stop_lying_iter:
    type: int?
    doc: "Iteration at which TSNE learning rate is reduced. Try \nincreasing this
      if TSNE results do not look good on larger \nnumbers of cells. Cannot be set
      higher than tsne_max_iter. \nDefault: 250\n"
  tsne_mom_switch_iter:
    type: int?
    doc: "Iteration at which TSNE momentum is reduced. Try \nincreasing this if TSNE
      results do not look good on \nlarger numbers of cells. Cannot be set higher
      than \ntsne_max_iter.\nDefault: 250\n"
  umap_input_pcs:
    type: int?
    doc: "Subset to top N principal components for UMAP. Change \nthis parameter if
      you want to see how the UMAP plot \nchanges when using fewer PCs, independent
      of the \nclustering/differential expression. You may find that \nUMAP is faster
      and/or the output looks better when \nusing fewer PCs. Cannot be set higher
      than the \nnum_principal_comps parameter.\nDefault: null\n"
  umap_n_neighbors:
    type: int?
    doc: "Determines the number of neighboring points used in \nlocal approximations
      of manifold structure. Larger values \nwill usually result in more global structure
      at the loss \nof detailed local structure. Ranges from 5 to 50. \nDefault: 30\n"
  umap_max_dims:
    type: int?
    doc: "Maximum number of UMAP output dimensions. Set this to 3 \nto produce both
      2D and 3D UMAP projections. Ranges from 2 \nto 3.\nDefault: 2\n"
  umap_min_dist:
    type: float?
    doc: "Controls how tightly the embedding is allowed to pack points \ntogether.
      Larger values make embedded points more evenly \ndistributed, while smaller
      values make the embedding more \naccurate with regard to the local structure.
      Ranges from \n0.001 to 0.5.\nDefault: 0.3\n"
  umap_metric:
    type:
      - 'null'
  ...
  random_seed:
    ...
    doc: "Random seed. Due to the randomized nature of the algorithms, \nchanging
      this will produce slightly different results. If \nthe TSNE or UMAP results
      don't look good, try running \nmultiple times with different seeds and pick

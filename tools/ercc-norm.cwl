...
doc: "\nTool for building linear regression function from ERCC ExFold mix 1 RPKM (molecule
  per cell vs RPKM), and applying this for normalization of RNA-Seq RPKM count data.\n\
  \n  Primary Output files:\n   - unaligned_pairs-to-ERCC.sam\n   - ercc_counts.tsv\n\
  \   - isoforms.ercc_norm_rpkm.csv\n   - ercc_expected_v_actual_count_plot.pdf\n\n\
  \  PARAMS:\n  -h  help\tshow this message\n  -t  INT\tnumber of threads\n  -u  FILE\
  \   array of unaligned \"R1,R2\" reads post-primary alignment\n  -d  FLOAT  dilution
  factor used for ERCC ExFold mix 1 before spike-in\n  -m  FLOAT  volume of ERCC ExFold
  mix 1 spike-in to sample per million cells\n  -c  FILE   csv file containing isoform
  counts (format: RefseqId,GeneId,Chrom,TxStart,TxEnd,Strand,TotalReads,Rpkm)\n\n
  ____________________________________________________________________________________________________\n
  References:\n- Langmead B, Salzberg S. Fast gapped-read alignment with Bowtie 2.
  Nature Methods. 2012, 9:357-359.\n- Twelve years of SAMtools and BCFtools. Danecek
  et al. GigaScience, Volume 10, Issue 2, February 2021, giab008, https://doi.org/10.1093/gigascience/giab008\n\
  \    "
